...
[![Build Status](https://img.shields.io/github/actions/workflow/status/kevinoid/NLCaseConvert/dotnet.yml?branch=main&style=flat&label=build)](https://github.com/kevinoid/NLCaseConvert/actions/workflows/dotnet.yml?query=branch%3Amain)
